...
# ========== কনফিগারেশন – আপনার তথ্য দিয়ে পূরণ করা আছে (আপডেটেড কুকি) ==========
...
# 🔥 আপডেট করা কুকি (PHP সেশন আইডি) 🔥
SESSION_COOKIE = os.getenv(
    "SESSION_COOKIE",
    "0908720fb6156fd09321441e2c2a5fbe"  # আপনার দেওয়া নতুন কুকি
)
TARGET_URL = os.getenv(
    "TARGET_URL",
    "http://147.135.212.148/ints/agent/res/data_smscdr.php"  # নতুন URL (147.135.212.148)
)
